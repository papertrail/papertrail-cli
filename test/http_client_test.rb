...
class HttpClientTest < Minitest::Test
  describe "http methods" do
    ...
    def test_cli_version_present_in_http_methods
      ...
      stub_request(:post, "https://papertrailapp.com/api/v1/some-path").
        with(body: "cli_version=#{Papertrail::VERSION}")
        .to_return(status: 200, body: "", headers: {})
      http.post("some-path",{})


      stub_request(:put, "https://papertrailapp.com/api/v1/some-path").
        with(body: "cli_version=#{Papertrail::VERSION}")
        .to_return(status: 200, body: "", headers: {})
      http.put("some-path",{})

      stub_request(:delete, /https:\/\/papertrailapp.com\/api\/v1\/some-path\?cli_version=#{Papertrail::VERSION}/)
        .to_return(status: 200, body: "", headers: {})
